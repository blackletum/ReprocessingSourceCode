...
bool CHudZoom::VidInit()
{
	m_hBottom_Left = SPR_Load("sprites/zoom/sniper_bottom_left.spr");
	m_hBottom_Right = SPR_Load("sprites/zoom/sniper_bottom_right.spr");
	m_hTop_Left = SPR_Load("sprites/zoom/sniper_top_left.spr");
	m_hTop_Right = SPR_Load("sprites/zoom/sniper_top_right.spr");
	m_hBlack = SPR_Load("sprites/zoom/sniper_black.spr");
	m_iHudMode = 0;
	return 1;
}
...
bool CHudZoom::Draw(float flTime)
{
