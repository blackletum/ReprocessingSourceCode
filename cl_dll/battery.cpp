...
bool CHudBattery::Draw(float flTime)
{
	...
	//y = gHUD.m_iHudScaleWidth - gHUD.m_iFontHeight - gHUD.m_iFontHeight / 2;
	y = gHUD.m_iHudScaleHeight - gHUD.m_iFontHeight - gHUD.m_iFontHeight / 1.75;
	//x = gHUD.m_iHudScaleHeight / 4;
