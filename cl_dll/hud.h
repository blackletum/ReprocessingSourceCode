...
#define RGB_YELLOWISH 0x87CEEF	 //255,160,0 real one - 0x87CEEF //old one - 0x00D0FEFF
...
public:
	...
	int m_iHudScaleWidth, m_iHudScaleHeight;
...
public:
	...
	bool MsgFunc_CardHud(const char* pszName, int iSize, void* pbuf);
	...
	int _cdecl MsgFunc_Impact(const char *pszName, int iSize, void *pbuf);//Ku2zoff
