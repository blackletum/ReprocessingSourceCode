...
extern void TRI_FillRGBA(float x, float y, float width, float height, int r, int g, int b, int a);
...
{
	TRI_SprAdjustSize((float *)&x, (float *)&y, 0, 0);
...
inline int ConsoleStringLen(const char* string)
{
	...
	int w = _width;
	TRI_SprAdjustSize(0, 0, (float *)&w, 0);
