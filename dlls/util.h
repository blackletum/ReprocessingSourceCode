...
// Misc. Prototypes
extern void UTIL_RoundHullSize(Vector size, bool down);
extern float UTIL_GetModelMaxDim(entvars_t* ent);
extern Vector UTIL_GetModelMinSize(entvars_t* ent);
extern Vector UTIL_GetModelMaxSize(entvars_t* ent);
extern float UTIL_GetModelHeight(entvars_t* ent);
extern void UTIL_SetModelSize(entvars_t* ent);
