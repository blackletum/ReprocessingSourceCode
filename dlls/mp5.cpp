...
void CMP5::Reload()
{
	...
	if (m_iClip != 0)
		DefaultReload(MP5_MAX_CLIP, MP5_RELOAD, 2.3);
	else
		switch (RANDOM_LONG(0, 1))
		{
		case 0:
			DefaultReload(MP5_MAX_CLIP, MP5_RELOAD_EMPTY1, 2.9);
			break;
		case 1:
			DefaultReload(MP5_MAX_CLIP, MP5_RELOAD_EMPTY2, 3.27);
			break;
		}
}
...
class CMP5Chainammo : public CBasePlayerAmmo
{
	...
	bool AddAmmo(CBaseEntity* pOther) override
	{
		pOther->GiveAmmo(AMMO_M16CLIP_GIVE * 2, "556", _556_MAX_CARRY);
		pOther->GiveAmmo(AMMO_357BOX_GIVE * 2, "357", _357_MAX_CARRY);
