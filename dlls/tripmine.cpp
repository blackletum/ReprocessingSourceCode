...
class CTripmineGrenade : public CGrenade
{
	...
	//void DeactiveteUse(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value);
...
void CTripmineGrenade::Spawn()
{
	...
	//SetUse(&CTripmineGrenade::DeactiveteUse);
...
/*
void CTripmineGrenade::DeactiveteUse(CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value)
{
