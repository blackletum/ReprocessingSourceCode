...
class CMengele : public CScientist
{
public:
	void Spawn() override;
	void Precache() override;
...
LINK_ENTITY_TO_CLASS(monster_evil_scientist, CMengele);

//=========================================================
// Classify - indicates this monster's place in the
// relationship table.
//=========================================================
int CMengele::Classify()
{
...
//=========================================================
// Dead x-lab Scientist PROP
//=========================================================
class CDeadMengele : public CBaseMonster
{
public:
	void Spawn() override;
	int Classify() override { return CLASS_HUMAN_PASSIVE; }
...
const char* CDeadMengele::m_szPoses[] = { "lying_on_back", "lying_on_stomach", "dead_sitting", "dead_hang", "dead_table1", "dead_table2", "dead_table3" };

bool CDeadMengele::KeyValue(KeyValueData* pkvd)
{
	if (FStrEq(pkvd->szKeyName, "pose"))
	{
		m_iPose = atoi(pkvd->szValue);
...
LINK_ENTITY_TO_CLASS(monster_evil_scientist_dead, CDeadMengele);

//
// ********** DeadScientist SPAWN **********
//
void CDeadMengele::Spawn()
{
	PRECACHE_MODEL("models/xlabsci.mdl");
	SET_MODEL(ENT(pev), "models/xlabsci.mdl");
