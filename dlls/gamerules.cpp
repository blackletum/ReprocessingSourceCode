...
void CGameRules::RefreshSkillData()
{
	...
	// ZSlave
	gSkillData.zslaveHealth = GetSkillCvar("sk_zslave_health");
	gSkillData.zslaveDmgClaw = GetSkillCvar("sk_zslave_dmg_claw");
	gSkillData.zslaveDmgClawrake = GetSkillCvar("sk_zslave_dmg_clawrake");
	gSkillData.zslaveDmgZap = GetSkillCvar("sk_zslave_dmg_zap");
