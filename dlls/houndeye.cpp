...
class CNamRat : public CHoundeye
{
public:
	void Spawn() override;
	void Precache() override;
...
// that occur when tagged animation frames are played.
//=========================================================
void CNamRat::HandleAnimEvent(MonsterEvent_t* pEvent)
{
	switch (pEvent->event)
	{
	case HOUND_AE_WARN:
	...
	case HOUND_AE_ANGERSOUND1:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "rat/ratpain2.wav", 1, ATTN_NORM);
		break;

	case HOUND_AE_ANGERSOUND2:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "rat/ratpain1.wav", 1, ATTN_NORM);
		break;
...
void CNamRat::Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/hell_rat.mdl");
	UTIL_SetSize(pev, Vector(-16, -16, 0), Vector(16, 16, 36));
...
void CNamRat::Precache()
{
	...
	PRECACHE_SOUND("rat/ratalert4.wav");

	PRECACHE_SOUND("rat/ratdie1.wav");
	PRECACHE_SOUND("rat/ratdie2.wav");
	PRECACHE_SOUND("rat/ratdie3.wav");
	PRECACHE_SOUND("rat/ratdie4.wav");
	PRECACHE_SOUND("rat/ratdie5.wav");

	PRECACHE_SOUND("rat/ratidle1.wav");
	PRECACHE_SOUND("rat/ratidle2.wav");
	PRECACHE_SOUND("rat/ratidle3.wav");
	PRECACHE_SOUND("rat/ratidle4.wav");

	PRECACHE_SOUND("rat/ratpain1.wav");
	PRECACHE_SOUND("rat/ratpain2.wav");
	PRECACHE_SOUND("weapons/grenade_pinpull.wav");
...
// IdleSound
//=========================================================
void CNamRat::IdleSound()
{
	switch (RANDOM_LONG(0, 3))
	{
	case 0:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "rat/ratidle1.wav", 1, ATTN_NORM);
		break;
	case 1:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "rat/ratidle2.wav", 1, ATTN_NORM);
		break;
	case 2:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "rat/ratidle3.wav", 1, ATTN_NORM);
		break;
	case 3:
		EMIT_SOUND(ENT(pev), CHAN_VOICE, "rat/ratidle4.wav", 1, ATTN_NORM);
		break;
	}
}
...
// WarnSound
//=========================================================
void CNamRat::WarnSound()
{
	switch (RANDOM_LONG(0, 3))
	{
	case 0:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratalert1.wav", 0.7, ATTN_NORM);
		break;
	case 1:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratalert2.wav", 0.7, ATTN_NORM);
		break;
	case 2:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratalert3.wav", 0.7, ATTN_NORM);
		break;
	case 3:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratalert4.wav", 0.7, ATTN_NORM);
		break;
	}
}
...
// DeathSound
//=========================================================
void CNamRat::DeathSound()
{
	switch (RANDOM_LONG(0, 4))
	{
	case 0:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratdie1.wav", 0.7, ATTN_NORM);
		break;
	case 1:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratdie2.wav", 0.7, ATTN_NORM);
		break;
	case 2:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratdie3.wav", 0.7, ATTN_NORM);
		break;
	case 3:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratdie4.wav", 0.7, ATTN_NORM);
		break;
	case 4:
		EMIT_SOUND(ENT(pev), CHAN_WEAPON, "rat/ratdie5.wav", 0.7, ATTN_NORM);
		break;
	}
}
