...
{
	if (newActivity == ACT_IDLE && IsTalking() && (LookupActivity(ACT_SIGNAL3) != ACTIVITY_NOT_AVAILABLE))
	{
		newActivity = ACT_SIGNAL3;
	}
	else if (newActivity == ACT_SIGNAL3 && (LookupActivity(ACT_SIGNAL3) == ACTIVITY_NOT_AVAILABLE))
	{
