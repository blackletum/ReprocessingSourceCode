...
class CHFgrunt : public CBaseMonster
{
public:
	void Spawn() override;
...
LINK_ENTITY_TO_CLASS(monster_human_fgrunt, CHFgrunt);


TYPEDESCRIPTION CHFgrunt::m_SaveData[] =
	{
		DEFINE_FIELD(CHFgrunt, m_flLastShot, FIELD_TIME),
		DEFINE_FIELD(CHFgrunt, m_flDiviation, FIELD_FLOAT),

		DEFINE_FIELD(CHFgrunt, m_flNextJump, FIELD_TIME),
		DEFINE_FIELD(CHFgrunt, m_vecJumpVelocity, FIELD_VECTOR),
		...
		DEFINE_FIELD(CHFgrunt, m_iTargetRanderamt, FIELD_INTEGER),
		DEFINE_FIELD(CHFgrunt, m_iFrustration, FIELD_INTEGER),
};

IMPLEMENT_SAVERESTORE(CHFgrunt, CBaseMonster);
...
void CHFgrunt::Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/hfgrunt.mdl");
...
{
	PRECACHE_MODEL("models/hfgrunt.mdl");
...
IMPLEMENT_CUSTOM_SCHEDULES(CHFgrunt, CBaseMonster);
