...
void CHandGrenade::PrimaryAttack()
{
	...
	if (0 != m_flStartThrow)
	{
		...
		{
			time = 0;
			CGrenade::ShootTimed(m_pPlayer->pev, m_pPlayer->pev->origin, m_pPlayer->pev->velocity, time);
			m_flStartThrow = 0;
			...
			m_pPlayer->TakeDamage(CWorld::World->pev, CWorld::World->pev, 300, DMG_BLAST);
		}
	}
}
