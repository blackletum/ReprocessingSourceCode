...
public:
	...
	EHANDLE m_hOverEnemy;	// the entity that the monste if forced to fight
	...
	virtual bool IsRusher() { return false; }
...
#ifdef GATESEQ
	// ku2zoff
	virtual bool FHaveGait(void) { return true; }
	virtual void MaintainGait(void);
	virtual void SetGait();
	Activity m_actionActivity;
	Activity m_Gait;
	Activity m_IdealGait;
