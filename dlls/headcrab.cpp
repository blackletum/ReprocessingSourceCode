...
//=========================================================
// BigCrab aka Alpha HeadCrab aka BigMothaFucka
//=========================================================

class CBigCrab : public CHeadCrab
{
public:
	void Spawn() override;
	void Precache() override;
	float GetDamageAmount() override { return gSkillData.headcrabDmgBite * 10; }
	int GetVoicePitch() override { return PITCH_NORM + RANDOM_LONG(140, 150); }
	float GetSoundVolue() override { return 0.8; }
};
LINK_ENTITY_TO_CLASS(monster_bigcrab, CBigCrab);

void CBigCrab::Spawn()
{
	CHeadCrab::Spawn();
	SET_MODEL(ENT(pev), "models/bigcrab.mdl");
	UTIL_SetSize(pev, Vector(-12, -12, 0), Vector(12, 12, 24));

	pev->health = gSkillData.headcrabHealth + 5; // more health
}

void CBigCrab::Precache()
{
	PRECACHE_MODEL("models/bigcrab.mdl");
	CHeadCrab::Precache();
}