...
// ZSlave
cvar_t sk_zslave_health1 = { "sk_zslave_health1", "0" };
cvar_t sk_zslave_health2 = { "sk_zslave_health2", "0" };
cvar_t sk_zslave_health3 = { "sk_zslave_health3", "0" };

cvar_t sk_zslave_dmg_claw1 = { "sk_zslave_dmg_claw1", "0" };
cvar_t sk_zslave_dmg_claw2 = { "sk_zslave_dmg_claw2", "0" };
cvar_t sk_zslave_dmg_claw3 = { "sk_zslave_dmg_claw3", "0" };

cvar_t sk_zslave_dmg_clawrake1 = { "sk_zslave_dmg_clawrake1", "0" };
cvar_t sk_zslave_dmg_clawrake2 = { "sk_zslave_dmg_clawrake2", "0" };
cvar_t sk_zslave_dmg_clawrake3 = { "sk_zslave_dmg_clawrake3", "0" };

cvar_t sk_zslave_dmg_zap1 = { "sk_zslave_dmg_zap1", "0" };
cvar_t sk_zslave_dmg_zap2 = { "sk_zslave_dmg_zap2", "0" };
cvar_t sk_zslave_dmg_zap3 = { "sk_zslave_dmg_zap3", "0" };
...
void GameDLLInit()
{
	...
	// Archer
	CVAR_REGISTER(&sk_archer_health1);  // {"sk_apache_health1","0"};
	CVAR_REGISTER(&sk_archer_health2);  // {"sk_apache_health2","0"};
	CVAR_REGISTER(&sk_archer_health3);	// {"sk_apache_health3","0"};

	CVAR_REGISTER(&sk_archer_dmg_bite1); // {"sk_apache_health1","0"};
	CVAR_REGISTER(&sk_archer_dmg_bite2);	 // {"sk_apache_health2","0"};
	CVAR_REGISTER(&sk_archer_dmg_bite3);	 // {"sk_apache_health3","0"};

	CVAR_REGISTER(&sk_archer_min_beam_delay1); // {"sk_apache_health1","0"};
	CVAR_REGISTER(&sk_archer_min_beam_delay2);  // {"sk_apache_health2","0"};
	CVAR_REGISTER(&sk_archer_min_beam_delay3);  // {"sk_apache_health3","0"};

	CVAR_REGISTER(&sk_archer_dmg_zap1); // {"sk_apache_health1","0"};
	CVAR_REGISTER(&sk_archer_dmg_zap2);	// {"sk_apache_health2","0"};
	CVAR_REGISTER(&sk_archer_dmg_zap3);	// {"sk_apache_health3","0"};
	...
	// ZSlave
	CVAR_REGISTER(&sk_zslave_health1); // {"sk_islave_health1","0"};
	CVAR_REGISTER(&sk_zslave_health2); // {"sk_islave_health2","0"};
	CVAR_REGISTER(&sk_zslave_health3); // {"sk_islave_health3","0"};

	CVAR_REGISTER(&sk_zslave_dmg_claw1); // {"sk_islave_dmg_claw1","0"};
	CVAR_REGISTER(&sk_zslave_dmg_claw2); // {"sk_islave_dmg_claw2","0"};
	CVAR_REGISTER(&sk_zslave_dmg_claw3); // {"sk_islave_dmg_claw3","0"};

	CVAR_REGISTER(&sk_zslave_dmg_clawrake1); // {"sk_islave_dmg_clawrake1","0"};
	CVAR_REGISTER(&sk_zslave_dmg_clawrake2); // {"sk_islave_dmg_clawrake2","0"};
	CVAR_REGISTER(&sk_zslave_dmg_clawrake3); // {"sk_islave_dmg_clawrake3","0"};

	CVAR_REGISTER(&sk_zslave_dmg_zap1); // {"sk_islave_dmg_zap1","0"};
	CVAR_REGISTER(&sk_zslave_dmg_zap2); // {"sk_islave_dmg_zap2","0"};
	CVAR_REGISTER(&sk_zslave_dmg_zap3); // {"sk_islave_dmg_zap3","0"};
	...
	// Stuka
	CVAR_REGISTER(&sk_stuka_health1); // {"sk_stuka_health1","0"};
	CVAR_REGISTER(&sk_stuka_health2); // {"sk_stuka_health2","0"};
	CVAR_REGISTER(&sk_stuka_health3); // {"sk_stuka_health3","0"};

	CVAR_REGISTER(&sk_stuka_dmg_slash1); // {"sk_stuka_dmg_slash1","0"};
	CVAR_REGISTER(&sk_stuka_dmg_slash2); // {"sk_stuka_dmg_slash2","0"};
	CVAR_REGISTER(&sk_stuka_dmg_slash3); // {"sk_stuka_dmg_slash3","0"};

	CVAR_REGISTER(&sk_stuka_dmg_bomb1); // {"sk_stuka_dmg_bomb1","0"};
	CVAR_REGISTER(&sk_stuka_dmg_bomb2); // {"sk_stuka_dmg_bomb2","0"};
	CVAR_REGISTER(&sk_stuka_dmg_bomb3); // {"sk_stuka_dmg_bomb3","0"};
	...
	// M60 Round
	CVAR_REGISTER(&sk_plr_762_bullet1); // {"sk_plr_m16_bullet1","0"};
	CVAR_REGISTER(&sk_plr_762_bullet2); // {"sk_plr_m16_bullet2","0"};
	CVAR_REGISTER(&sk_plr_762_bullet3); // {"sk_plr_m16_bullet3","0"};
