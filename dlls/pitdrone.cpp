...
class CHellHound : public CPitdrone
{
public:
	void Spawn() override;
	void Precache() override;
...
LINK_ENTITY_TO_CLASS(monster_nam_hound, CHellHound);
...
void CHellHound::Spawn()
{
	...
	SET_MODEL(ENT(pev), "models/hell_dog.mdl");
	UTIL_SetSize(pev, Vector(-16, -16, 0), Vector(16, 16, 48));
...
{
	PRECACHE_MODEL("models/hell_dog.mdl");
	PRECACHE_MODEL("models/pit_drone_gibs.mdl");
	...
	PRECACHE_SOUND("dog/he_alert1.wav");
	PRECACHE_SOUND("dog/he_alert2.wav");
	PRECACHE_SOUND("dog/he_alert3.wav");
	PRECACHE_SOUND("dog/he_attack1.wav");
	PRECACHE_SOUND("dog/he_attack2.wav");
	PRECACHE_SOUND("dog/he_attack3.wav");
	PRECACHE_SOUND("dog/he_die1.wav");
	PRECACHE_SOUND("dog/he_die2.wav");
	PRECACHE_SOUND("dog/he_die3.wav");
	PRECACHE_SOUND("dog/he_hunt1.wav");
	PRECACHE_SOUND("dog/he_hunt2.wav");
	PRECACHE_SOUND("dog/he_hunt3.wav");
	PRECACHE_SOUND("dog/he_hunt4.wav");
	PRECACHE_SOUND("dog/he_idle1.wav");
	PRECACHE_SOUND("dog/he_idle2.wav");
	PRECACHE_SOUND("dog/he_idle3.wav");
	PRECACHE_SOUND("dog/he_pain1.wav");
	PRECACHE_SOUND("dog/he_pain2.wav");
	PRECACHE_SOUND("dog/he_pain3.wav");
	PRECACHE_SOUND("dog/he_pain4.wav");
	PRECACHE_SOUND("dog/he_pain5.wav");

}

int CHellHound::IRelationship(CBaseEntity *pTarget)
{
	//Always mark pit drones as allies
	if (FClassnameIs(pTarget->pev, "monster_nam_hound"))
	{
		return R_AL;
	}
...
void CHellHound::IdleSound()
{
	...
	{
	case 0:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_idle1.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 1:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_idle2.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 2:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_idle3.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	}
}
...
void CHellHound::PainSound()
{
	...
	{
	case 0:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_pain1.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 1:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_pain2.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 2:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_pain3.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 3:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_pain4.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 4:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_pain5.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	}
}
...
void CHellHound::AlertSound()
{
	...
	{
	case 0:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_alert1.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 1:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_alert2.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	case 2:
		EMIT_SOUND_DYN(ENT(pev), CHAN_VOICE, "dog/he_alert3.wav", 1, ATTN_NORM, 0, iPitch);
		break;
	}
}
...
void CHellHound::HandleAnimEvent(MonsterEvent_t *pEvent)
{
	...
	case PITDRONE_AE_BITE:
	{
		...
		{
		case 0:
			EMIT_SOUND_DYN(ENT(pev), CHAN_WEAPON, "dog/he_attack1.wav", 1, ATTN_NORM, 0, iPitch);
			break;
		case 1:
			EMIT_SOUND_DYN(ENT(pev), CHAN_WEAPON, "dog/he_attack2.wav", 1, ATTN_NORM, 0, iPitch);
			break;
		}
		CBaseEntity *pHurt = CheckTraceHullAttack(70, gSkillData.pitdroneDmgBite, DMG_SLASH);
	...
	case PITDRONE_AE_HOP:
	{
		...
		{
		case 0:
			EMIT_SOUND_DYN(ENT(pev), CHAN_WEAPON, "dog/he_hunt1.wav", 1, ATTN_NORM, 0, iPitch);
			break;
		case 1:
			EMIT_SOUND_DYN(ENT(pev), CHAN_WEAPON, "dog/he_hunt2.wav", 1, ATTN_NORM, 0, iPitch);
			break;
		case 2:
			EMIT_SOUND_DYN(ENT(pev), CHAN_WEAPON, "dog/he_hunt3.wav", 1, ATTN_NORM, 0, iPitch);
			break;
		case 3:
			EMIT_SOUND_DYN(ENT(pev), CHAN_WEAPON, "dog/he_hunt4.wav", 1, ATTN_NORM, 0, iPitch);
			break;
		}
